  ...
  return (
    <div className={cn(" mx-auto p-2", !isHome && "p-0")}>
      {isHome && (
        <>
          <GradualSpacing
            className=" text-left text-xl font-bold tracking-[-0.1em] text-black dark:text-white md:text-4xl md:leading-[5rem] text-wrap"
      ...
      <div className="mt-4 lg:mt-0 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 h-full lg:h-[calc(100vh-228px)] overflow-y-auto">
        {isLoading
          ? Array(8)
              .fill(0)
